...
<div class="row">
  	<div class="col-md-12">
  		<p>
		At Analyzr we make it a priority to keep the client data safe through a defined system of vigorous security practices.  Below are some of the reasons why we can confidently assure you that your data will be secure with Analyzr.
		</p>
	</div>
	<div class="col-md-12">
  		<p>
		<strong>Secure Data Centers</strong><br/>
		At Analyzr we store our data with some of the most reputable data centers on the market today, such as Amazon AWS. These data centers are both certified with ISO/IEC 27001:2005, SAS70 Type II compliance as well as the PCI DSS Level 1 compliance.
	...
	<div class="col-md-12">
		...
		To maximize secure data handling and storage, we encrypt all data processed through Analyzr. Our encryption techniques are highly-developed to ensure that our data is processed in the most secure manner and protected from all threats.
		</p>
	</div>
	<div class="col-md-12">
  		<p>
	...
	<div class="col-md-12">
		...
		At Analyzr, we want you to be confident in our trustworthiness, and for this reason we have strong partnerships with one of the most reliable names on the market Amazon AWS. 
		<br/>
		Xervmon, parent organization of Analyzr holds the official positions of a AWS APN Technology Partnership.
		</p>
	</div>
	<div class="col-md-12">
  		<p>
		<strong>HIPAA Sensitive Environments</strong><br/>
		Your data is secure with Analyzr as our product is designed to work under HIPAA sensitive environments requirements. Although HIPAA does not provide an official certification for any SaaS solution, we have carefully designed out tool to ensure that it fulfills the requirements of the HIPAA. Alternatively, you could subscribe for on-premise version of Xervmon
	...
	<div class="col-md-12">
		...
		<strong>Dedicated To Meet Your Data Security Needs</strong><br/>
		 At Analyzr, we take full responsibility for your data security, and we are always proactive to improve and develop our systems and procedures.
	...
	<div class="col-md-12">
		...
		At Analyzr, we value our customers and their loyalty to us and will make sure our product and service is running forever.  We do understand the concerns, that being a startup, there is always a questions about life-expectancy.startups get acquired or die.
