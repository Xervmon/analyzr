...
{{-- Content --}}
@section('content')
@section('breadcrumbs', Breadcrumbs::render('VpcsInfo',$account->id))

<div class="page-header">
	<div class="row">
		<div class="col-md-9">
			<h5>{{{ Lang::get('account/account.awsVPCDetails') }}} : <a href="{{ URL::to('account/'.$account->id.'/edit') }}">{{ $account->name }} </a></h5>
		</div>
	</div>
</div>
