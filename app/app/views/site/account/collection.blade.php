...
$(document).ready(function() {
  ...
  $('#collections').html('<img src="{{asset('assets/img/ajax-loader.gif')}}" id="ajaxSpinnerImage" title="working..." style="margin-top:20px; margin-left: 500px;" width:100px; height="100px" width="100px">');
  $.ajax({
