		...
		<div class="row clearfix">
			...
			<div class="col-md-4 column footer-social">
				...
				<p class=" footer-social-icons">
					<a href="https://github.com/awsusageanalyzr"><img width="32px" height="32px" src="{{{ asset('assets/img/providers/GitHub-Mark-32px.png') }}}" alt="{{{ Lang::get('site.footertitle') }}}"/></a>
