	                    ...
	                    <ul class="nav navbar-nav pull-right">
	                        @if (Auth::check())
		                        ...
		                        <li class="dropdown">
		                        	...
		                        	<ul class="dropdown-menu">
	    								...
	    								<li class="divider"></li>
	    								<li><a href="{{{ URL::to('security/portPreferences') }}}"><span class="glyphicon glyphicon-lock"></span> {{{ Lang::get('site.portPreferences') }}}</a></li>
	    								<li class="divider"></li>
	                        ...
	                        @else
	                         @if(Request::url()==URL::to('/'))
	                          	<li id="howitworks"><a href="#Howitworks">Features</a></li>
	                         @else
	                         	<li id="howitworks"><a href="{{{ URL::to('/').'#Howitworks' }}}">Features</a></li>
	                         @endif	
